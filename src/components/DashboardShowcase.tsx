        ...
        <div className="xl:col-span-1 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-4">
            {MOCK_METRICS.map((metric) => (
              <div
                key={metric.id}
                className="p-5 rounded-2xl bg-[#191514] border border-[#2e2826] hover:border-accent/30 transition-all group duration-300"
              >
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className={`text-[11px] font-medium font-mono ${
                    metric.trend === "down" ? "text-accent" : "text-[#10b981]"
                  }`}>
                    {metric.change}
                  </span>
                </div>
                ...
                <AreaChart data={CHART_DYNAMIC_DATA} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                  <defs>
                    ...
                    <linearGradient id="colorStaffing" x1="0" y1="0" x2="0" y2="1">
                      ...
                      <stop offset="95%" stopColor="#FF4E00" stopOpacity={0.01}/>
                    </linearGradient>
                  </defs>
                ...
                return (
                  <button
                    ...
                    className={`cursor-pointer w-full text-left p-4 rounded-xl transition-all duration-300 border flex flex-col md:flex-row md:items-center justify-between gap-3 ${
                      isSelected
                        ? "bg-[#211a18] border-accent shadow-lg"
