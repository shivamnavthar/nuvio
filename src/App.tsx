...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0a0a] text-[#f7f3f0] selection:bg-[#eb5a3c] selection:text-white">
      
      {/* BACKGROUND FLOATING INGREDIENTS & PARTICLES GRAPHIC LAYER */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        <div className="absolute top-[18%] left-[8%] animate-float-slow opacity-15 text-[#eb5a3c]">
          <Wine className="h-10 w-10 text-[#eb5a3c]" strokeWidth={1} />
        </div>
        <div className="absolute top-[42%] right-[5%] animate-float-fast opacity-10">
          <Leaf className="h-12 w-12 text-[#eb5a3c]" strokeWidth={1} />
        </div>
        ...
        <div className="absolute top-[82%] right-[10%] animate-float-fast opacity-10">
          <GlassWater className="h-10 w-10 text-[#eb5a3c]" strokeWidth={1} />
        </div>
        {/* Soft, blurred glowing gradients in backgrounds */}
        <div className="absolute top-[10%] left-[20%] w-[450px] h-[450px] bg-[#eb5a3c]/5 rounded-full blur-[140px]" />
        <div className="absolute top-[55%] right-[15%] w-[500px] h-[500px] bg-[#eb5a3c]/3 rounded-full blur-[160px]" />
        <div className="absolute bottom-[10%] left-[10%] w-[350px] h-[350px] bg-[#eb5a3c]/4 rounded-full blur-[120px]" />
      </div>
      ...
      <header 
        className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
          scrolled 
            ? "bg-[#0b0a0a]/90 backdrop-blur-md border-b border-[#211d1c]/80 py-4 shadow-lg" 
            : "bg-transparent py-6"
        }`}
        role="banner"
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <a href="#" className="flex items-center gap-3 group focus:outline-none" aria-label="Aura Operations Home">
            <div className="relative flex items-center justify-center p-2 rounded-xl bg-[#eb5a3c] text-white overflow-hidden transition-all duration-300 shadow group-hover:shadow-[#eb5a3c]/35">
            ...
            <div className="flex flex-col">
              <span className="font-heading text-lg font-bold tracking-[0.15em] text-[#fdecdb] uppercase flex items-center gap-1">
                Aura <span className="font-sans font-normal text-[10px] tracking-normal lowercase px-1.5 py-0.5 bg-[#421d17] text-[#eb5a3c] rounded-full">AI</span>
              </span>
              <span className="text-[9px] font-mono tracking-widest text-[#9c8b82] uppercase">RESTAURANT OS</span>
            </div>
          </a>

          {/* Nav middle links */}
          <nav className="hidden lg:flex items-center gap-8" role="navigation" aria-label="Main Navigation">
            <a href="#dashboard-section" className="text-sm font-medium text-[#bcaea6] hover:text-[#f7f3f0] focus:text-[#f7f3f0] transition-colors focus:outline-none">Live Ops Hub</a>
            <a href="#features-section" className="text-sm font-medium text-[#bcaea6] hover:text-[#f7f3f0] focus:text-[#f7f3f0] transition-colors focus:outline-none">Features</a>
            <a href="#ai-advisor-tool-anchor" className="text-sm font-medium text-[#bcaea6] hover:text-[#f7f3f0] focus:text-[#f7f3f0] transition-colors focus:outline-none">Operations Auditor</a>
            <a href="#pricing-section" className="text-sm font-medium text-[#bcaea6] hover:text-[#f7f3f0] focus:text-[#f7f3f0] transition-colors focus:outline-none">Pricing</a>
            <a href="#faq-section" className="text-sm font-medium text-[#bcaea6] hover:text-[#f7f3f0] focus:text-[#f7f3f0] transition-colors focus:outline-none">FAQ</a>
          </nav>
          ...
          <div className="flex items-center gap-4">
            <a 
              ...
              className="hidden sm:inline-flex px-5 py-2.5 bg-[#eb5a3c] hover:bg-[#f26a4e] text-white text-xs font-semibold rounded-lg uppercase tracking-wider transition-all focus:outline-none shadow-md hover:shadow-[#eb5a3c]/20"
            >
              Book Advisory Call
            </a>
          </div>
      ...
      <main id="main-content" role="main">
          ...
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col items-start gap-6">
              <div className="inline-flex items-center gap-2.5 px-3.5 py-1.5 rounded-full bg-[#1c1816] border border-[#3e3431] text-xs font-medium text-[#fdecdb] animate-pulse">
                <Sparkles className="h-4 w-4 text-[#eb5a3c]" />
              ...
              <h1 className="font-heading text-4xl sm:text-5xl xl:text-6xl font-extrabold tracking-tight text-[#f7f3f0] leading-[1.08] text-balance">
                AI That Helps Restaurants <span className="text-[#eb5a3c]">Operate Smarter</span>
              </h1>

              <p className="text-base sm:text-lg text-[#bcaea6] leading-relaxed max-w-xl text-pretty">
              ...
              <div className="flex flex-col sm:flex-row w-full sm:w-auto gap-4 mt-2">
                <a 
                  href="#contact-section" 
                  className="cursor-pointer px-8 py-4 bg-[#eb5a3c] hover:bg-[#f26a4e] text-white font-bold rounded-xl text-sm transition-all text-center flex items-center justify-center gap-2.5 group shadow-lg shadow-[#eb5a3c]/15"
                >
                ...
                >
                  <Clock className="h-4 w-4 text-[#eb5a3c]" />
            ...
            <div className="lg:col-span-6 relative flex items-center justify-center">
              ...
              <div className="relative rounded-3xl overflow-hidden shadow-2xl border border-[#302826] bg-[#120f0e] aspect-[4/3] w-full max-w-xl transform rotate-1 hover:rotate-0 transition-all duration-700 hover:scale-[1.02] group">
                ...
                <div className="absolute top-6 left-6 p-4 rounded-xl bg-[#0b0a0a]/75 backdrop-blur-md border border-white/5 animate-float-slow">
                ...
                <div className="absolute bottom-8 right-6 p-4 rounded-xl bg-[#eb5a3c]/90 text-white border border-[#ff8d75]/25 animate-float-fast shadow-xl">
        ...
        <section className="py-12 border-y border-[#211c1b] bg-[#0d0b0b] overflow-hidden" aria-label="Restaurant Trust Indicators">
          <div className="max-w-7xl mx-auto px-6 mb-4 text-center">
            <span className="text-xs font-mono uppercase tracking-[0.25em] text-[#9c8b82]">
          ...
          <div className="relative w-full overflow-hidden mt-6">
            <div className="flex animate-marquee gap-10">
              ...
              {RESTAURANT_LOGOS.concat(RESTAURANT_LOGOS).map((logo, index) => (
                <div 
                  key={index} 
                  className="mx-4 flex flex-col sm:flex-row items-center gap-3 bg-[#141211] border border-[#2b2523] px-5 py-3 rounded-xl hover:border-[#eb5a3c]/45 transition-colors duration-300"
                >
                  <Store className="h-4 w-4 text-[#eb5a3c]" />
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="font-heading font-semibold text-xs text-[#fdecdb] tracking-wider uppercase">
                        {logo.name}
                      </span>
                      <span className="text-[10px] text-[#eb5a3c]">{logo.rating}</span>
                    </div>
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto z-10" id="dashboard-section" aria-label="Interactive Dashboard Showcase">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2.5 px-3 py-1 rounded-full bg-[#1c1816] border border-[#3e3431] text-xs font-medium text-[#eb5a3c] mb-4">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-[#f7f3f0]">
              Say Goodbye to Management <span className="text-[#eb5a3c]">by Guesswork</span>
            </h2>
        ...
        {/* TRUST METRICS CARDS */}
        <section className="py-12 bg-[#0d0c0c] border-y border-[#292220]">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="p-6">
              <span className="text-4xl sm:text-5xl font-heading font-extrabold text-[#eb5a3c] block mb-2">18.4%</span>
              <span className="text-xs uppercase font-mono tracking-widest text-[#9c8b82]">Average Labor overhead Reduced</span>
            ...
            <div className="p-6 border-y md:border-y-0 md:border-x border-[#2d2624]">
              ...
              <span className="text-xs uppercase font-mono tracking-widest text-[#9c8b82]">Optimal Course Orders Forecasted</span>
            ...
            <div className="p-6">
              <span className="text-4xl sm:text-5xl font-heading font-extrabold text-[#eb5a3c] block mb-2">32%</span>
              <span className="text-xs uppercase font-mono tracking-widest text-[#9c8b82]">Average Food Spoils Deflection</span>
        ...
        <section className="py-24 px-6 bg-[#0c0a0a] border-t border-[#1a1716]" id="features-section" aria-label="System Capabilities">
          <div className="max-w-7xl mx-auto">
            
            <div className="text-center max-w-3xl mx-auto mb-20">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#2c1d19] border border-[#eb5a3c]/35 text-xs text-[#eb5a3c] mb-4">
                <Cpu className="h-3.5 w-3.5 animate-spin" />
                <span className="font-mono uppercase tracking-widest text-[9px]">Deep Feature Engineering</span>
              </div>
              <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-[#f7f3f0]">
                Built for High-Level <span className="text-[#eb5a3c]">Executive Control</span>
              </h2>
              <p className="text-sm text-[#bcaea6] mt-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {CORE_FEATURES.map((feat) => {
                let cardIcon = <Sparkles className="h-5 w-5 text-[#eb5a3c]" />;
                if (feat.id === "forecasting") cardIcon = <TrendingUp className="h-5 w-5 text-[#eb5a3c]" />;
                if (feat.id === "labor") cardIcon = <Flame className="h-5 w-5 text-[#eb5a3c]" />;
                if (feat.id === "inventory") cardIcon = <UtensilsCrossed className="h-5 w-5 text-[#eb5a3c]" />;
                if (feat.id === "insights") cardIcon = <ClipboardCheck className="h-5 w-5 text-[#eb5a3c]" />;
                if (feat.id === "growth") cardIcon = <Cpu className="h-5 w-5 text-[#eb5a3c]" />;
                if (feat.id === "multi-location") cardIcon = <Store className="h-5 w-5 text-[#eb5a3c]" />;

                return (
                  <div 
                    key={feat.id}
                    className="p-8 rounded-2xl bg-[#141211] border border-[#2b2523] hover:border-[#eb5a3c]/40 transition-transition group duration-300 transform hover:translate-y-[-4px] relative"
                  >
                    <div className="h-12 w-12 bg-[#211a18] border border-[#3e3431] rounded-xl flex items-center justify-center mb-6 group-hover:bg-[#eb5a3c] group-hover:text-white transition-colors duration-500">
                      {cardIcon}
                    </div>

                    <span className="text-[10px] font-mono font-semibold uppercase tracking-widest text-[#eb5a3c] block mb-1">
                      {feat.badge}
                    </span>
                    ...
                    <div className="border-t border-[#2d2624] pt-4 space-y-2.5">
                      {feat.details.map((detail, dIdx) => (
                        <div key={dIdx} className="flex items-start gap-2">
                          <Check className="h-3.5 w-3.5 text-[#eb5a3c] shrink-0 mt-0.5" />
                          <span className="text-[11px] text-[#9c8b82] leading-tight flex-1">{detail}</span>
                        </div>
                      ))}
                    </div>
                  </div>
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto text-center" aria-label="Implementation Flow">
          <div className="max-w-2xl mx-auto mb-16">
            <span className="text-xs font-mono uppercase tracking-[0.25em] text-[#9c8b82] block mb-4">
              Aura Deployment Architecture
            </span>
            <h2 className="font-heading text-3xl sm:text-4xl font-bold tracking-tight text-[#f7f3f0]">
              Smooth 3-Step Setup
            </h2>
            <p className="text-sm text-[#bcaea6] mt-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 relative">
            ...
            <div className="hidden lg:block absolute top-12 left-[28%] right-[28%] h-[1px] bg-gradient-to-r from-[#eb5a3c]/40 via-[#bcaea6]/10 to-[#eb5a3c]/40 z-0 pointer-events-none" />

            {/* Step 1 */}
            <div className="flex flex-col items-center gap-4 relative z-10 p-6 rounded-2xl hover:bg-[#12100f] duration-300">
              <div className="h-14 w-14 rounded-full bg-[#191514] border border-[#eb5a3c]/35 flex items-center justify-center font-heading text-[#eb5a3c] font-bold text-lg shadow-lg">
                I
              </div>
              <h3 className="font-heading text-lg font-bold text-[#f7f3f0] mt-2">Connect POS Credentials</h3>
              <p className="text-xs text-[#bcaea6] max-w-xs leading-relaxed">
            ...
            {/* Step 2 */}
            <div className="flex flex-col items-center gap-4 relative z-10 p-6 rounded-2xl hover:bg-[#12100f] duration-300">
              <div className="h-14 w-14 rounded-full bg-[#eb5a3c] text-white flex items-center justify-center font-heading font-bold text-lg shadow-lg">
                II
              </div>
        ...
        <section className="py-24 px-6 bg-[#0a0909] border-y border-[#292220] z-10" aria-label="Customer Success Stories">
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
            
            {/* Left intro copy */}
            <div className="lg:w-1/3 flex flex-col items-start gap-4">
              <div className="inline-flex items-center gap-2 text-xs font-mono text-[#eb5a3c] uppercase tracking-widest bg-[#2e1d19] px-3.5 py-1 rounded-full border border-[#eb5a3c]/35">
              ...
              <p className="text-xs sm:text-sm text-[#bcaea6] leading-relaxed text-left">
                ...
                {TESTIMONIALS.map((t, idx) => (
                  <button 
                    ...
                    className={`cursor-pointer h-2.5 rounded-full transition-all duration-300 ${
                      activeTestimonial === idx ? "w-8 bg-[#eb5a3c]" : "w-2.5 bg-[#2d2624] hover:bg-[#4a403d]"
                    }`}
              ...
              {TESTIMONIALS.map((t, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1.5 text-xs font-mono text-[#eb5a3c] mb-6">
                    ...
                    <div className="border-t border-[#292221] mt-8 pt-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                      <div className="flex items-center gap-4">
                        <img 
                          ...
                          alt={t.author} 
                          referrerPolicy="no-referrer"
                          className="h-12 w-12 rounded-full object-cover border border-[#eb5a3c]/35"
                        />
                        <div>
        ...
        <section className="py-24 px-6 max-w-7xl mx-auto" id="pricing-section" aria-label="Subscription Pricing">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20">
            <span className="text-xs font-mono uppercase tracking-[0.25em] text-[#eb5a3c] block mb-4">
              Return on Investment
            </span>
            <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-[#f7f3f0]">
              Executive Investment Plans
            </h2>
            <p className="text-sm text-[#bcaea6] mt-4 leading-relaxed">
            ...
            {PRICING_PLANS.map((plan) => (
              <div 
                ...
                className={`p-8 rounded-3xl border transition-all duration-500 relative flex flex-col justify-between ${
                  plan.isPopular 
                    ? "bg-[#191412] border-[#eb5a3c] shadow-2xl scale-[1.03] glow-soft z-10" 
                    : "bg-[#141211] border-[#2b2523] shadow hover:border-[#3a3331]"
                }`}
              >
                {/* Popular Highlight Badge */}
                {plan.isPopular && (
                  <div className="absolute top-0 right-8 transform -translate-y-1/2 bg-[#eb5a3c] text-white text-[10px] font-mono leading-none tracking-widest uppercase py-1.5 px-3 rounded-full font-bold">
                    RECOMMENDED CHOICE
                  </div>
                )}
                ...
                <div>
                  ...
                  <p className="text-[11px] text-[#bcaea6] italic mb-6 leading-relaxed bg-[#1d1917] p-2.5 rounded-lg border border-[#3e3432]">
                    {plan.description}
                  </p>

                  <div className="flex items-baseline gap-2 mb-6 border-b border-[#2b2523] pb-6">
                    <span className="text-3xl sm:text-4xl lg:text-5xl font-bold font-heading text-[#eb5a3c]">{plan.price}</span>
                    <span className="text-xs text-[#9c8b82] font-mono">{plan.billing}</span>
                  </div>

                  {/* Bullet features list */}
                  <div className="space-y-4 mb-8">
                    {plan.features.map((feat, f_idx) => (
                      <div key={f_idx} className="flex items-start gap-3 text-xs leading-relaxed text-[#bcaea6]">
                        <div className="p-0.5 rounded bg-[#eb5a3c]/15 text-[#eb5a3c] shrink-0 mt-0.5">
                ...
                <a 
                  ...
                  className={`cursor-pointer w-full text-center py-3.5 px-6 font-bold rounded-xl text-xs uppercase tracking-wider transition-all inline-block ${
                    plan.isPopular 
                      ? "bg-[#eb5a3c] hover:bg-[#f26a4e] text-white shadow-md hover:shadow-[#eb5a3c]/20" 
        ...
        <section className="py-24 px-6 bg-[#0d0c0c] border-t border-[#292220] z-10 relative overflow-hidden" id="contact-section" aria-label="Contact Section">
          <div className="absolute top-0 left-[50%] transform translate-x-[-50%] w-[800px] h-[300px] bg-[#eb5a3c]/5 rounded-full blur-[140px] pointer-events-none" />
          ...
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
            ...
            <div className="lg:col-span-5 flex flex-col items-start gap-4 text-left">
              <span className="text-xs font-mono uppercase tracking-[0.25em] text-[#eb5a3c] font-semibold">
              ...
              <div className="mt-6 space-y-4">
                <div className="flex items-center gap-3">
                  <MapPin className="h-4 w-4 text-[#eb5a3c] shrink-0" />
                  <span className="text-xs text-[#bcaea6] font-mono">112 Crosby Street, NY 10012</span>
                </div>
                <div className="flex items-center gap-3">
                  <Mail className="h-4 w-4 text-[#eb5a3c] shrink-0" />
                  <span className="text-xs text-[#bcaea6] font-mono">founders@aurasystems.io</span>
                </div>
                <div className="flex items-center gap-3">
                  <Phone className="h-4 w-4 text-[#eb5a3c] shrink-0" />
                  <span className="text-xs text-[#bcaea6] font-mono">+1 (800) Aura-Al-OS</span>
                </div>
              </div>
            </div>
                  ...
                  <form onSubmit={handleBookDemoSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="flex flex-col gap-1.5 text-left">
                        <label className="text-[10px] uppercase tracking-wider text-[#bcaea6] font-semibold">Your Full Name</label>
                        <input
                          type="text"
                          required
                          value={leadName}
                          ...
                          className="w-full bg-[#1c1816]/70 border border-[#38302e] text-xs focus:border-[#eb5a3c] rounded-lg px-4 py-3 text-white focus:outline-none transition-colors"
                        />
                      </div>

                      {/* Phone */}
                      <div className="flex flex-col gap-1.5 text-left">
                        <label className="text-[10px] uppercase tracking-wider text-[#bcaea6] font-semibold">Secret Desk Phone</label>
                        <input
                          type="tel"
                          value={leadPhone}
                      ...
                      <div className="flex flex-col gap-1.5 text-left col-span-1 sm:col-span-2">
                        <label className="text-[10px] uppercase tracking-wider text-[#bcaea6] font-semibold">Corporate Email Address</label>
                        <input
                          type="email"
                          required
                          value={leadEmail}
                      ...
                      {/* Restaurant name */}
                      <div className="flex flex-col gap-1.5 text-left">
                        <label className="text-[10px] uppercase tracking-wider text-[#bcaea6] font-semibold">Restaurant Group Name</label>
                        <input
                          type="text"
                          required
                      ...
                      {/* locations count */}
                      <div className="flex flex-col gap-1.5 text-left">
                        <label className="text-[10px] uppercase tracking-wider text-[#bcaea6] font-semibold">Total Unit Scale</label>
                        <select
                          value={leadLocations}
                          onChange={(e) => setLeadLocations(Number(e.target.value))}
                          className="w-full bg-[#1c1816]/70 border border-[#38302e] text-xs focus:border-[#eb5a3c] rounded-lg px-4 py-3 text-white focus:outline-none cursor-pointer"
                        >
                      ...
                      {/* current POS */}
                      <div className="flex flex-col gap-1.5 text-left col-span-1 sm:col-span-2">
                        <label className="text-[10px] uppercase tracking-wider text-[#bcaea6] font-semibold">Primary Platform POS Integration</label>
                        <select
                          value={leadPosSystem}
                    ...
                    <button
                      ...
                      className="cursor-pointer w-full py-4 px-6 bg-[#eb5a3c] hover:bg-[#f26a4e] text-white font-bold rounded-xl text-xs uppercase tracking-wider transition-all shadow-md hover:shadow-[#eb5a3c]/35 flex items-center justify-center gap-2"
                    >
                      {bookingLoading ? (
                        <>
                    ...
                    <span className="text-[10px] text-center text-[#9c8b82] block leading-normal mt-3">
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="cursor-pointer w-full text-left p-6 flex justify-between items-center gap-4 text-white hover:text-[#eb5a3c] focus:outline-none focus:text-[#eb5a3c]"
                  ...
                  >
                    ...
                    <ChevronDown className={`h-4 w-4 text-[#eb5a3c] shrink-0 transition-transform duration-300 ${
                      isOpen ? "rotate-180" : ""
                    }`} />
                  </button>
      ...
      {/* FOOTER SECTION */}
      <footer className="bg-[#080707] border-t border-[#211c1b] py-16 px-6 z-10 relative" role="contentinfo">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
          
          {/* Main info Brand footer block */}
          <div className="md:col-span-4 flex flex-col items-start gap-4">
            <a href="#" className="flex items-center gap-3">
              <div className="p-2 rounded-lg bg-[#eb5a3c] text-white flex items-center justify-center">
            ...
            <p className="text-xs text-[#bcaea6] max-w-sm leading-relaxed text-left">
            ...
            <div className="text-[10px] font-mono text-[#9c8b82] tracking-wider mt-4">
          ...
          <div className="md:col-span-4 grid grid-cols-2 gap-8 text-left w-full">
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="#dashboard-section" className="text-xs text-[#bcaea6] hover:text-[#eb5a3c] transition-colors">Operations Hub</a>
              <a href="#features-section" className="text-xs text-[#bcaea6] hover:text-[#eb5a3c] transition-colors">System Features</a>
              <a href="#ai-advisor-tool-anchor" className="text-xs text-[#bcaea6] hover:text-[#eb5a3c] transition-colors">B2B Audit Tool</a>
              <a href="#pricing-section" className="text-xs text-[#bcaea6] hover:text-[#eb5a3c] transition-colors">Subscription Pricing</a>
            </div>

            <div className="flex flex-col gap-3">
              <h4 className="text-xs font-bold text-[#fdecdb] uppercase tracking-wider">Legal & Trust</h4>
              <a href="#faq-section" className="text-xs text-[#bcaea6] hover:text-[#eb5a3c] transition-colors">Platform FAQ</a>
              <span className="text-xs text-[#9c8b82]">ADA Compliance Check</span>
              <span className="text-xs text-[#9c8b82]">SOC-2 Cert Type II</span>
              <span className="text-xs text-[#9c8b82]">Privacy Matrix</span>
            </div>
          ...
          <div className="md:col-span-4 flex flex-col items-start gap-4 w-full">
            ...
            >
              ...
              <button
                type="submit"
                className="cursor-pointer bg-[#eb5a3c] hover:bg-[#f26a4e] text-white text-[11px] font-bold px-4 py-2.5 rounded-lg uppercase tracking-wider transition-all"
              >
                Join
              </button>
            </form>
        ...
        >
          <div className="w-full max-w-3xl rounded-3xl overflow-hidden shadow-2xl border border-[#3a3230] bg-[#120f0f] p-6 lg:p-8 flex flex-col gap-6 scale-[1.01] transition-transform relative">
            <div className="flex items-center justify-between border-b border-[#2d2624] pb-4">
              <div className="flex items-center gap-2">
                <PlaySquare className="h-5 w-5 text-[#eb5a3c]" />
            ...
            <div className="relative rounded-2xl aspect-video bg-[#000] border border-[#2e2624] flex flex-col items-center justify-center text-center p-8 overflow-hidden">
              ...
              <div className="relative h-16 w-16 rounded-full bg-[#eb5a3c]/15 border border-[#eb5a3c] flex items-center justify-center mb-4 z-10 animate-pulse text-[#eb5a3c]">
                <Activity className="h-8 w-8 text-[#eb5a3c]" />
              </div>
